(function($) {
  ...
  $(function() {
    ...
    if ($("#visit-sale-chart").length) {
      ...
      $("#visit-sale-chart-legend").php(myChart.generateLegend());
    }
    if ($("#visit-sale-chart-dark").length) {
      ...
      $("#visit-sale-chart-legend-dark").php(myChart.generateLegend());
    }
    if ($("#traffic-chart").length) {
      ...
      $("#traffic-chart-legend").php(trafficChart.generateLegend());      
    }
